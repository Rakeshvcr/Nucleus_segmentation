...
![alt text](https://github.com/Rakeshvcr/Nucleus_segmentation/blob/master/images/u-net-architecture.png) { width = 100px;}

## Result

![alt text](https://github.com/Rakeshvcr/Nucleus_segmentation/blob/master/images/Image.png =750x350)
